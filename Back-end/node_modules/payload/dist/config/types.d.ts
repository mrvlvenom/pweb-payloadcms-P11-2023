...
export type LocalizationConfigWithNoLabels = Prettify<BaseLocalizationConfig & {
    /**
...
export type LocalizationConfigWithLabels = Prettify<BaseLocalizationConfig & {
    /**
...
export type SanitizedLocalizationConfig = Prettify<LocalizationConfigWithLabels & {
    /**
     * List of supported locales
     * @example `["en", "es", "fr", "nl", "de", "jp"]`
     */
...
export type SanitizedConfig = Omit<DeepRequired<Config>, 'collections' | 'endpoint' | 'globals' | 'localization'> & {
...
export type EntityDescription = (() => string) | React.ComponentType<any> | Record<string, string> | string;
export {};
